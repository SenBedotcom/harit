...
if("TRUE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /home/harit/test_ws/src/ar_track_alvar/ar_track_alvar_msgs)
  set(ar_track_alvar_msgs_DEVEL_PREFIX /home/harit/test_ws/devel)
  ...
  set(ar_track_alvar_msgs_INSTALL_PREFIX /home/harit/test_ws/install)
...
if(NOT "/home/harit/test_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/harit/test_ws/src/ar_track_alvar/ar_track_alvar_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ar_track_alvar_msgs_NUM_DUMMY_TARGETS)
      set(ar_track_alvar_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ar_track_alvar_msgs::wrapped-linker-option${ar_track_alvar_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ar_track_alvar_msgs_NUM_DUMMY_TARGETS "${ar_track_alvar_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ar_track_alvar_msgs::wrapped-linker-option${ar_track_alvar_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ar_track_alvar_msgs_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ar_track_alvar_msgs_EXPORTED_TARGETS ${${ar_track_alvar_msgs_dep}_EXPORTED_TARGETS})
endforeach()
